...
class _TasksScreenState extends State<TasksScreen> {
  ...
  List<dynamic> get filterTaskList => [];
            ...
            actionWidgets: [
              ...
              PopupMenuButton<String>(
                ...
                itemBuilder: (BuildContext context) {
                  return [
                    const PopupMenuItem(
                        value: "Export to CSV", child: Text("Export to CSV")),
                    const PopupMenuItem(
                        value: "Export to Excel",
                        child: Text("Export to Excel")),
                    const PopupMenuItem(
                        value: "Save as PDF", child: Text("Save as PDF")),
                  ];
                },
              ),
            ],
                    ...
                    return state.tasks.isNotEmpty || state.isSearching
                        ...
                        : Center(
                            child: Column(
                              ...
                              children: [
                                SvgPicture.asset('assets/svgs/tasks.svg',
